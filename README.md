...
由于未知原因，即使已经尽可能模仿真实浏览器特征，登录状态仍然只能保存24小时。    
已使用基于tampermonkey的脚本完整实现所有功能，并增加视频下载等功能，见[RainClassroom_Plugin](https://github.com/c0d805e15c550432/RainClassroom_Plugin)
